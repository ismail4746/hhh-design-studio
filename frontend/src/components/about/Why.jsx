  ...
  return (
    <section className="py-24 bg-[#0c0c0c] text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-[#D4AF37] to-[#b8902d] bg-clip-text text-transparent tracking-wider"
            style={{ fontFamily:"'Playfair Display', serif" }}>
          Why HHH Design Studio?
        </h2>
        <p className="text-gray-400 max-w-3xl mx-auto mb-8 md:mb-14 text-base md:text-lg" style={{fontFamily:"'Poppins',sans-serif"}}>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-10">
          {[
            ...
            <motion.div
              ...
              className="bg-[#141414]/80 p-6 md:p-8 rounded-3xl hover:-translate-y-2 hover:shadow-[0_0_60px_#D4AF37]/30 transition"
            >
