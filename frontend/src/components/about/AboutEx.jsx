  ...
  return (
    <section className="py-20 bg-[#0f0f0f] text-white">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        {/* Card 1: Experience */}
        <div className="bg-[#1c1c1c] p-8 rounded-3xl border border-[#2f2f2f] hover:-translate-y-2 hover:shadow-[0_0_40px_#D4AF37]/30 transition">
          <div className="flex items-center gap-4 mb-5">
            <div className="bg-[#D4AF37]/20 p-4 rounded-full">
              <FaAward className="text-[#D4AF37]" size={32} />
            </div>
        ...
        {/* Card 2: Projects */}
        <div className="bg-[#1c1c1c] p-8 rounded-3xl border border-[#2f2f2f] hover:-translate-y-2 hover:shadow-[0_0_40px_#b8902d]/30 transition">
          <div className="flex items-center gap-4 mb-5">
            <div className="bg-[#b8902d]/20 p-4 rounded-full">
              <FaBriefcase className="text-[#b8902d]" size={32} />
            </div>
            <h3 className="text-3xl font-bold">
          ...
          <button className="mt-auto px-6 py-2 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#b8902d] text-black font-semibold hover:opacity-90 transition">
            Visit Projects
          </button>
        </div>

        {/* Card 3: Sustainable + Modern */}
        <div className="bg-[#1c1c1c] p-8 rounded-3xl border border-[#2f2f2f] hover:-translate-y-2 hover:shadow-[0_0_40px_#75e08c]/30 transition mx-auto w-full md:col-span-2 md:w-1/2">
          <div className="flex items-center gap-4 mb-5">
            <div className="bg-[#75e08c]/20 p-4 rounded-full">
              <FaLeaf className="text-[#75e08c]" size={32} />
            </div>
            <h3 className="text-3xl font-bold">
