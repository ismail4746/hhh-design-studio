                ...
                <div className="space-y-28">
                    {services.map((service, index) => (
                        <div key={index} className="grid md:grid-cols-2 gap-12 items-center">
                            {/* Image */}
                            <div
                                className={`relative h-[450px] rounded-3xl overflow-hidden shadow-2xl group ${index % 2 === 1 ? "md:order-2" : "md:order-1"
                                    }`}
                            >
                                <img
                                    src={service.img}
                            ...
                            {/* Text */}
                            <div
                                className={`md:px-10 relative ${index % 2 === 1 ? "md:order-1" : "md:order-2"
                                    }`}
                            >
                                {/* Decorative Accent */}
