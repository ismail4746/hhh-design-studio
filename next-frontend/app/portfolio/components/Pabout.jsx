"use client"; // framer-motion ke liye
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8 leading-relaxed text-lg">
              With over 18 years of experience in architecture, interior design &
              project management. I've led projects that merge creativity with
              functionality. From luxury villas to corporate spaces — my focus is
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              {[
                ...
                >
                  <div className="text-4xl text-[#D4AF37] mx-auto mb-2">
                    {stat.icon}
                  </div>
