...
// ✅ Images ko public folder me rakho (e.g. /public/images/...)
const allProjects = [
  { id: 1, img: "/ar5.jpg", title: "Luxury Villa" },
  { id: 2, img: "/ar13.jpg", title: "Luxury Villa" },
  { id: 3, img: "/bd2.jpg", title: "King Size Bedroom" },
  { id: 4, img: "/bedroom3.jpg", title: "Luxury Bedroom" },
  { id: 5, img: "/interior15.jpg", title: "Luxury Lobby" },
  { id: 6, img: "/lobby1.jpg", title: "Lobby" },
];
    ...
    <section id="projects" className="py-20 bg-[#0f0f0f] text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mt-10">
          <motion.button
            onClick={() => router.push("/project")} // ✅ Next.js routing
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
