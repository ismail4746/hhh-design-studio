  ...
  return (
    <section className="py-24 bg-[#0c0c0c] text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        {/* Heading */}
        <h2
          className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-[#D4AF37] to-[#b8902d] bg-clip-text text-transparent tracking-wider"
          style={{ fontFamily:"'Playfair Display', serif" }}
        >
          Why HHH Design Studio?
        </h2>
        <p
          className="text-gray-400 max-w-3xl mx-auto mb-14 text-lg"
