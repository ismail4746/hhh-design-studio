...
// import ceoImg from "../../../public/assets/azeemCeo1.jpg";
    ...
    <section className="py-20 md:py-28 bg-[#0e0e0e] text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <p className="text-lg text-white mb-2 tracking-wide font-medium" style={{ fontFamily: "'Poppins',sans-serif" }}>
            Muhammad Azeem
          </p>
          ...
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-10" style={{ fontFamily: "'Poppins',sans-serif" }}>
