...
import logo from "../public/assets/logomm.png";
    ...
    <footer className="bg-black/90 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Link href="/" className="text-gray-300 hover:text-yellow-400 transition">Home</Link>
          ...
          <Link href="/portfolio" className="text-gray-300 hover:text-yellow-400 transition">Portfolio</Link>
          <Link href="/project" className="text-gray-300 hover:text-yellow-400 transition">Projects</Link>
        </div>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Link href="/contactDetails">
            <button className="mt-8 px-3 py-1.5 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-semibold hover:scale-105 hover:shadow-lg transition-all duration-300">
              Contact Us
            </button>
          </Link>
        </div>
